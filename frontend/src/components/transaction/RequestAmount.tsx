            ...
            <div className='flex flex-col w-full p-6 gap-2'>
              ...
              <div className='flex flex-col gap-1.5'>
                ...
                <input
                  ...
                  className='outline-none w-full text-medium border-b-1 pb-1 border-gray-300'
                />
              </div>
              ...
              <button
                ...
                className={`w-full py-2 text-white font-bold rounded-xl transition cursor-pointer mt-3 ${isValid ? 'bg-[#C6412A] hover:bg-[#A8321E]' : 'bg-gray-300 cursor-not-allowed'
                  }`}
              >
                Continue
              </button>
