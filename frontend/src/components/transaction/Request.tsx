    ...
    <div className='flex flex-col w-full h-screen'>
      <Layout>
        <div className='flex flex-col flex-grow items-center justify-center w-full h-full'>
          <div className='w-11/12 md:w-1/2 lg:w-1/3 bg-card flex flex-col rounded-xl shadow-md'>
            <Header />

            <div className='flex flex-col p-6 gap-6'>
              <h2 data-testid='request-details' className='text-foreground font-bold text-2xl'>Request Details</h2>
              ...
              <div className='flex flex-col gap-4'>
                ...
                {transactionNote && (
                  <div data-testid='recipient-note' className='flex flex-col gap-1'>
                    ...
                    <p className='p-2 bg-muted rounded-lg'>{transactionNote}</p>
                  </div>
                )}
