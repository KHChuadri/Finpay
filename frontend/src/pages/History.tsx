          ...
          <div className='flex flex-col sm:flex-row w-full md:w-auto gap-4 items-stretch'>
            <div className='relative flex-grow max-w-md'>
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-2 bg-card2 border border-border-strong text-foreground placeholder:text-subtle rounded-full focus:outline-none focus:ring-2 focus:ring-ring transition-all duration-200"
              />
            </div>
            ...
            <button
              ...
              className="flex flex-row rounded-full pl-6 pr-6 py-2 items-center justify-center bg-card2 border border-border-strong text-foreground hover:bg-hover
